        ...
        <div class="col-4 text-grey-span mt-4">
          <p class="d-flex mb-3">
            <img
              ...
              class="mr-2"
            />
            persepolisescolalivre@gmail.com
          </p>
          <p class="d-flex mb-3">
            <img
          ...
          <p class="d-flex mb-3">
            ...
            />
            <a
              href="https://www.instagram.com/persepolisescola/"
              style="text-decoration: revert; color: #2841c5"
              >@persepolisescola</a
            >
          </p>
        </div>
...
.container-fluid {
  ...
  background: var(--bsicas-gelo, #f3f3f3);
}
